...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='66602548942' #Enter UserID Here
        self.__username='samx4_bro' #Enter UserName Here
        self._session='66602548942:4eKVK2QoXEQOHv:13:AYePTTb5O7n4lM_l03u_irktrDFXpgZtcpyDou9P7w' #Enter SessionID Here
